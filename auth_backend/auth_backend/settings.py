...
SECRET_KEY = 'django-insecure-zsg6xtrm=ql^nk!*t8^qo-r_i)g63e7tm&bb#&1i&2+73w+zh-'
...
# }
# CORS 配置
#CORS_ALLOW_ALL_ORIGINS = True # 生产环境应限制为特定域名
...
REST_FRAMEWORK = {
    'DEFAULT_PARSER_CLASSES': [
        ...
        'common.parsers.PlainTextJSONParser',  # 自定义解析器
...
CACHES = {
    "default": {
        ...
        "OPTIONS": {
            ...
            "IGNORE_EXCEPTIONS": True,  # 缓存失败时不抛出异常
            "CONNECTION_POOL_KWARGS": {"max_connections": 100}
        },
        "KEY_PREFIX": "jobfinder_",  # 所有键的前缀
    }
}
